...
public class Application2 {
    ...
    public static void main(String[] args) {
        ...
        int bonusRate = getBonusRate(sell);
        int bonusSalary = (int) (bonusRate * sell)/100;
        ...
        String print = """
                ...
                ======================
                총 급여 : %d
                """.formatted(sell, bonusRate, salary, bonusSalary, totalSalary);
        System.out.println(print);


    } public static int getBonusRate(int sell) {
        if (sell >= 50000000) {
            return 5;
        }
        if (sell >= 30000000) {
